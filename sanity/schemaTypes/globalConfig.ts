...
export const globalConfig = defineType({
  ...
  fields: [
    ...
    defineField({
      ...
      title: 'URL Política de Privacidad',
      description: 'Enlace a la página o PDF de política de privacidad',
      type: 'url',
    }),
    defineField({
      name: 'termsUrl',
      title: 'URL Términos de Uso',
      description: 'Enlace a la página o PDF de términos y condiciones',
      type: 'url',
    }),
  ],
  preview: {
